...
usersRouter.post('/', async (request, response) => { //Cuando se hace el post en el frontend, nuestro backend recibe la request con la informacion enviada en el body de la request
